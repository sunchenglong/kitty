package com.qiyi.qiyu.kitty.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("kitty");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("kitty");
        ...
        config.getMapConfigs().put("com.qiyi.qiyu.kitty.domain.*", initializeDomainMapConfig(jHipsterProperties));
